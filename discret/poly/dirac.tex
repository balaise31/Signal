...
\begin{figure}[ht!]
  \centering \graphe{0.8\textwidth}{derivee_echelon}
...
\begin{figure}[ht!]
  \centering \graphe{\textwidth}{fonctions_et_distributions}
...
C'est ainsi que \Heaviside{} a remarqué que la composition des
...
la~\figref{fig:delta_mesure}
\begin{figure}[ht!]
  \centering \graphe{\textwidth}{delta_mesure}
...
\section{Propriété de convolution avec le \Dirac{} et l'impulsion unité}
